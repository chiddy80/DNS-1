...
# Configuration
REQUIRED_PASSWORD="Athumani"
SCRIPT1_URL="https://raw.githubusercontent.com/athumani2580/DNS/main/slowdns/no1.sh"
SCRIPT2_URL="https://raw.githubusercontent.com/athumani2580/DNS/main/slowdns/no2.sh"

# Show title
clear
echo ""
echo -e "${BLUE}===============================================================${NC}"
echo -e "${CYAN}           TANZANIA SLOWDNS INSTALLER${NC}"
echo -e "${BLUE}===============================================================${NC}"
echo -e "${WHITE}                  by Master${NC}"
echo -e "${BLUE}===============================================================${NC}"
echo ""
