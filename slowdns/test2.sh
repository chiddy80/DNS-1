...
# Create EDNS Proxy Python script (converts 512 to 1452)
...
- Outside sees 512, inside server sees 1452
"""
...
INTERNAL_EDNS_SIZE = 1452   # what we tell SlowDNS internally
